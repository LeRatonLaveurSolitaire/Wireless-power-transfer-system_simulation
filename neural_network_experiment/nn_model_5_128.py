...
class NN_model(nn.Module):
    ...
    def __init__(self, input_size: int = None, output_size: int = None):
        ...
        # self.hidden18_size = 100
        # self.hidden19_size = 100
        ...
        self.relu4 = nn.ReLU()
        self.linear5 = nn.Linear(self.hidden4_size, self.hidden5_size)
        self.relu5 = nn.ReLU()
        self.linear6 = nn.Linear(self.hidden5_size, self.output_size)
        # self.relu6 = nn.ReLU()
